...
namespace com.github.benpocalypse.circuitent
{
    public interface IEditor
    {
        ...
        public abstract void LeftButtonClicked (CircuitentDrawingSurface sender, double x, double y);
        public abstract void RightButtonClicked (CircuitentDrawingSurface sender, double x, double y);
    }
}
